<main id="main" class="pt-5rem">
    ...
    <input type="text" id="id-tipe" value="" hidden>
    <input type="text" id="id-tipe-perum" value="" hidden>
    <input type="text" id="satuan-hrg" value="" hidden>
    <input type="text" id="val-denahlt1" value="" hidden>
    <input type="text" id="val-denahlt2" value="" hidden>
</main>